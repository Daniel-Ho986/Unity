...
public class DataStructure3aManager : MonoBehaviour, DataStructureManager
{
    ...
    void Start()
    {
        ...
        question1and3Answers = new int[] { 31, 32, 32, 32, 31, 31, 31 };
        question2Answers = new int[] {     32, 71, 72, 73, 71, 72, 73 };
        question4Answers = new bool[] { false, true, true, true, true, true, true };
        ...
        solutionValues = new int[] { 71, 72, 73, 31, 32 };
        currentValues = new int[] { 31, 32, 71, 72, 73 };
    ...
    */
    ...
    void Update()
    {
        ...
        if (iterationStatuses[1] == false && space0.tag == "MemorySpace" && isBubbled0 == false)
        {
            if (space0.GetComponent<BoxScript>().GetNumber() == solutionValues[0])
            {
                ...
                {
                    //Note: The first index of iterationPhases2D is the solved state when
                    //        7 is bubbled to the end of the data structure
                ...
                if (correctlyBubbled)
                {
                    Debug.Log("NUMBER HAS BEEN BUBBLED!!! - number 7 at space 0");
                    isBubbled0 = true;
                }
            }
        }
        ...
        if (iterationStatuses[1] == false && space1.tag == "MemorySpace" && isBubbled1 == false)
        {
            if (space1.GetComponent<BoxScript>().GetNumber() == solutionValues[1])
            {
                ...
                for (int i = 0; i < size; i++)
                {
                    //Note: The first index of iterationPhases2D is the solved state when
                    //        7 is bubbled to the end of the data structure
                    //        --> Therefore, 5 is the first index
                    phaseArray[i] = iterationPhases2D[5, i];
                }
                ...
                if (correctlyBubbled)
                {
                    Debug.Log("NUMBER HAS BEEN BUBBLED!!! - number 7 at space 1");
                    isBubbled1 = true;
                }
            }
        }
        ...
        if (iterationStatuses[1] == false && space2.tag == "MemorySpace" && isBubbled2 == false)
        {
            if (space2.GetComponent<BoxScript>().GetNumber() == solutionValues[2])
            {
                ...
                if (correctlyBubbled)
                {
                    Debug.Log("NUMBER HAS BEEN BUBBLED!!! - number 7 at space 2");
                    isBubbled2 = true;
                }
            }
        }
