...
public class DataStructure2aManager : MonoBehaviour, DataStructureManager
{
    ...
    void Start()
    {
        ...
        question1and3Answers = new int[] { 5, 6, 7, 7, 5, 6, 6, 5, 5 };
        question2Answers = new int[] {     6, 7, 3, 4, 6, 3, 4, 3, 4 };
        question4Answers = new bool[] { false, false, true, true, false, true, true, true, true };
        ...
        solutionValues = new int[] { 3, 4, 5, 6, 7 };
        currentValues = new int[] { 5, 6, 7, 3, 4 };
    ...
    */
    ...
    void Update()
    {
        ...
        if (iterationStatuses[2] == false && space1.tag == "MemorySpace")
        {
        ...
        if (iterationStatuses[1] == false && space3.tag == "MemorySpace")
        {
            if (space3.GetComponent<BoxScript>().GetNumber() == solutionValues[3])
            {
                ...
                {
                    //Note: The first index of iterationPhases2D is the solved state when
                    //        6 is bubbled to the end of the data structure
