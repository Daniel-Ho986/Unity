...
public class LevelStart1SSCoroutine : MonoBehaviour
{
    public PromptManager promptManager;
    public DataStructure1SSManager dataManager;
    ...
    private bool firstTimeStep0;
    private bool isSubStep0;
    ...
    IEnumerator SortCoroutine()
    {
        if (firstTimeSortCoroutine)
        {
                ...
                && showingGameOver == false)
            {
                ...
                //TEMP REMOVAL: promptManager.HideTextBoxQuestion0();
            ...
            {
                firstTimeStep0 = true;
                isSubStep0 = true; //Continue the sorting phase as normal since the player has not lost
...
/*subStep0*/
        ...
        {
            if (firstTimeStep0 == true)
            {
                if (subStepIsStarting)
                {
                    Debug.Log("Now in step 0 of current iteration...");
                    subStepIsStarting = false;

                    //TEMP REMOVAL: promptManager.ShowTextBoxQuestion0();
                ...
                //TO_DO: Enable the player to answer question0
                //  -->IF they answer correctly, continue to sub step 1
                ...
                //           player continues to sub step 1
                ...
                if (selectReticle.GetComponent<ReticleScript>().GetConfirm())
                {
                    ...
                    if (isCorrectAnswer == true && hasCheckedAnswer == false)
                    {
                        ...
                        //TEMP REMOVAL: StartCoroutine(CorrectAnswer0Coroutine());
                    ...
                    else if (isCorrectAnswer == false && hasCheckedAnswer == false)
                    {
                        ...
                        //TEMP REMOVAL StartCoroutine(WrongAnswer0Coroutine());
                ...
                if (subStepIsEnding) //Hide question 0 (this is done once after
                {                    //  sub step 0 is answered)
                    Debug.Log("Ending step 0 of current iteration...");
                    firstTimeStep0 = false; //Only allow question 0 to appear once per iteration
                ...
                else //Keep updating as sub step 0 until the step is completed
                {
                    isSubStep0 = true;
            ...
            else if (firstTimeStep0 == false)
            {
                dataManager.IncrementIterationStageFrom(mainSubStep);
                mainSubStep = dataManager.GetIterationStage(); //The current step in iteration
                subStepIsStarting = true;
                isSubStep1 = true; //Continue the sorting phase from subStep1
            }

        }

/*subStep1*/ //***NOTE: CONTINUE EDITING FOR SELECTION SORT HERE***
...
/*mainStepSolved*/
    ...
    void Update()
    {
        ...
        if (isTimeToSolve)
        {
            ...
            else if (isSubStepMinus1) //Acts as the means of transitioning from battle phase
